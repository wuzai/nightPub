...
NSString *const KWZUserProfileFaceIconKey = @"faceIcon";
NSString *const KWZuserProfileRealNameKey = @"userName";
NSString *const KWZuserProfilePicKey = @"postImage";
...
{
    return [_changes count]?[NSMutableDictionary dictionaryWithDictionary:_changes]:nil;
}
